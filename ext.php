...
/**
*
* User Threshold Actions extension for the phpBB Forum Software package.
*
...
namespace prez\disable_colours;
	...
	function enable_step($old_state)
	{
		switch ($old_state)
		{
			case '': // Empty means nothing has run yet
				...
				$phpbb_notifications->enable_notifications('notification.type.disable_colours');
	...
	function disable_step($old_state)
	{
		switch ($old_state)
		{
			case '': // Empty means nothing has run yet
				...
				$phpbb_notifications = $this->container->get('notification_manager');
				$phpbb_notifications->disable_notifications('notification.type.disable_colours');
				return 'notifications';
			...
			case '': // Empty means nothing has run yet
				...
				*/
				try
				{
					...
					$phpbb_notifications = $this->container->get('notification_manager');
					$phpbb_notifications->purge_notifications('notification.type.disable_colours');
				}
